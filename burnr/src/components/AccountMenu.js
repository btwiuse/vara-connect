...
const AccountMenu = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, { onClick: handleClick, children: _jsx(ExpandMoreIcon, { style: { color: grey[500] } }) }), _jsxs(Menu, { transformOrigin: { vertical: -40, horizontal: "left" }, anchorEl: anchorEl, keepMounted: true, open: Boolean(anchorEl), onClose: () => setAnchorEl(null), className: classes.menu, children: [_jsx(ListItem, { dense: true, autoFocus: false, selected: false, children: _jsx(Typography, { variant: "overline", children: "Block explorers" }) }), _jsx(MenuItem, { onClick: () => openInNewTab(polkascanUri), children: "Polkascan" }), _jsx(MenuItem, { onClick: () => openInNewTab(polkastatsUri), children: "Polkastats" }), _jsx(BurnrDivider, {}), _jsx(ListItem, { dense: true, children: _jsx(Typography, { variant: "overline", children: "Export" }) }), _jsx(MenuItem, { onClick: () => downloadFile(userAddress, JSON.stringify(userJson), "json"), children: "JSON file" }), _jsx(MenuItem, { onClick: () => downloadFile(userAddress, userSeed, "txt"), children: "Seed Phrase" })] })] }));
};
