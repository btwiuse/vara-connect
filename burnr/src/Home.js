...
const Home = ({ account, loader }) => {
    ...
    return loader ? (_jsx(Paper, { className: classes.loadingPaper, children: _jsx(CircularProgress, {}) })) : (_jsxs(BalanceVisibleContext.Provider, { value: { balanceVisibility, setBalanceVisibility }, children: [_jsx(Paper, { square: true, className: classes.paperAccount, children: _jsxs(Box, { paddingY: 1, paddingX: 2, display: "flex", alignItems: "center", children: [_jsx(Box, { width: "50%", display: "flex", children: (account === null || account === void 0 ? void 0 : account.userAddress) && (_jsxs(_Fragment, { children: [_jsx(AccountCard, { account: {
                                        ...
                                        } }), _jsx(AccountMenu, {})] })) }), _jsxs(Box, { width: "50%", display: "flex", alignItems: "center", children: [_jsx(BalanceValue, { isVisible: balanceVisibility, unit: unit, value: balance, size: "large", style: { width: "100%", justifyContent: "flex-end" } }), _jsx(IconButton, { style: { borderRadius: 4 }, onClick: () => setBalanceVisibility(!balanceVisibility), children: balanceVisibility ? _jsx(VisibilityIcon, {}) : _jsx(VisibilityOffIcon, {}) })] })] }) }), _jsx(BurnrDivider, {}), _jsx(NavTabs, {})] }));
};
export default Home;
